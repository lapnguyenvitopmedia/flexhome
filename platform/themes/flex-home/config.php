    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function(Theme $theme)
        {
            ...
            $theme->asset()->usePath()->add('style-css', 'css/style.css', [], [], '1.0.2');

            if (BaseHelper::siteLanguageDirection() == 'rtl') {
                $theme->asset()->usePath()->add('rtl-style', 'css/rtl-style.css', [], [], '1.0.2');
            }
            ...
            $theme->asset()->container('footer')->usePath()->add('app-js', 'js/app.js', [], [], '1.0.2');
            $theme->asset()->container('footer')->usePath()->add('components-js', 'js/components.js', [], [], '1.0.2');
